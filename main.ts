...
input.onGesture(Gesture.Shake, function () {
    ...
    if (hand == 1) {
        basic.showLeds(`
            ...
            # # # # #
            `)
        music.playSoundEffect(music.createSoundEffect(WaveShape.Square, 5000, 1, 255, 225, 500, SoundExpressionEffect.None, InterpolationCurve.Linear), SoundExpressionPlayMode.UntilDone)
    } else if (hand == 2) {
        basic.showLeds(`
            . . . . .
            . # # # .
